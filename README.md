...
| <a name="input_folder_id"></a> [folder\_id](#input\_folder\_id) | The folder identifier that resources belongs to | `string` | `null` | no |
...
| <a name="input_platform_id"></a> [platform\_id](#input\_platform\_id) | Hardware platform name (Intel Ice Lake by default) | `string` | `"standard-v3"` | no |
